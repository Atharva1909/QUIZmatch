...
export default function SignupPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to QuizMatch!",
      });
  ...
  function handleGoogleSignup() {
    ...
    // Simulate Google authentication - replace with Firebase Auth
    setTimeout(() => {
      setIsLoading(false);
      toast({
        title: "Account created",
    ...
    <div className="min-h-screen flex flex-col justify-center items-center p-4 bg-muted/40">
      <div className="w-full max-w-md space-y-6 bg-card p-8 rounded-lg shadow-sm border">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">Sign up to start learning and competing</p>
        </div>
